...
import 'corewait/navigation/app_routes.dart';
import 'corewait/theme/app_theme.dart';
import 'corewait/di/dependency_injection.dart';
        ...
        ChangeNotifierProvider(
          create:
              (_) => RfidScanBloc(
                ...
                DependencyInjection.getIt.get<CreateAssetUseCase>(),
